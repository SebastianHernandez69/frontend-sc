    ...
    <div className="flex space-x-6">
      ...
      <div className="flex flex-col items-center bg-white p-4 rounded-lg shadow-md w-60">
        <div className="w-24 h-24 rounded-full bg-gray-200 flex items-center justify-center overflow-hidden">
          {vistaPreviaFoto ? (
            <img src={vistaPreviaFoto} alt="Foto de perfil" className="w-full h-full object-cover" />
          ) : (
            <span className="text-sm text-gray-500">Foto</span>
          )}
        </div>
        <Input type="file" accept="image/*" onChange={manejarCambioFoto} className="my-2 mt-4" />
        ...
        {pestañaActiva === "datosPersonales" ? (
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <div className="flex flex-col space-y-2">
                <label className="text-gray-700 font-medium">Nombre de la Materia:</label>
                <Input name="nombre" className="my-2" placeholder="Nombre de la Materia" />
              </div>
              <div className="flex flex-col space-y-2">
                <label className="text-gray-700 font-medium">Categoría:</label>
                <Input name="categoria" className="my-2" placeholder="Categoría de la Materia" />
              </div>
              <div className="flex flex-col space-y-2">
